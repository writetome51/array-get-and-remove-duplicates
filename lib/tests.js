...
if (arrays_match_1.arraysMatch(arr, [4, 5, 6, 7, 8, 9, 10, 1, 2, 3]))
...
if (arrays_match_1.arraysMatch(arr, [true, 10, false, '', 2, 1, 5, 'h', 20, 'mertyujkl;']))
...
if (arrays_match_1.arraysMatch(arr, [true, 10, false, 2, 'h', 1, 5, [1, 2, 3]]))
...
duplicates = getAndRemoveDuplicates_1.getAndRemoveDuplicates(arr);
if (arrays_match_1.arraysMatch(duplicates, [false]))
    console.log('test 7 passed');
else
    console.log('test 7 failed');
// Test 8: make sure those items were removed from array:
if (arrays_match_1.arraysMatch(arr, [[1, 2, 3], 10, 2, 'h', 1, 5, 6, false]))
